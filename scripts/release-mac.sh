...
REPO_NAME="FaxanaduRecomp"      # GitHub repo / zip basename
APP_NAME="Faxanadu"        # .app display name (may contain spaces)
TARGET="FaxanaduRecomp"            # cmake target == built binary filename in build-mac/
SYSTEM="nes"            # nes | snes | genesis | vb | psx
VERSION="v2.1.0-macos"          # release tag, e.g. v0.1.0-macos
ROM_HINT="Faxanadu (USA) .nes dump"        # human description of the ROM the user must supply
# ==============================================
