...
rem           committed generated/ for the pinned recompiler.
rem
rem Mirrors SuperMarioBrosRecomp\build_all.bat. tools\make_release.ps1 calls this.
...
echo === RELEASE BUILD DONE: build_release\FaxanaduRecomp.exe ===
